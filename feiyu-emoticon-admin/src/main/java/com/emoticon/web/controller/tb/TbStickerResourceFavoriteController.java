 ...
 */
@RestController
@RequestMapping("/system/stickerResourceFavorite")
public class TbStickerResourceFavoriteController extends BaseController
{
    @Autowired
     ...
     * 查询表情包资源收藏列表
     */
    @PreAuthorize("@ss.hasPermi('system:stickerResourceFavorite:list')")
    @GetMapping("/list")
     ...
     * 导出表情包资源收藏列表
     */
    @PreAuthorize("@ss.hasPermi('system:stickerResourceFavorite:export')")
     ...
     * 获取表情包资源收藏详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:stickerResourceFavorite:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增表情包资源收藏
     */
    @PreAuthorize("@ss.hasPermi('system:stickerResourceFavorite:add')")
     ...
     * 修改表情包资源收藏
     */
    @PreAuthorize("@ss.hasPermi('system:stickerResourceFavorite:edit')")
     ...
     * 删除表情包资源收藏
     */
    @PreAuthorize("@ss.hasPermi('system:stickerResourceFavorite:remove')")
